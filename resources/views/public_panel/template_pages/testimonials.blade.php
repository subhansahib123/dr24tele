    ...
    <section class="testimonial-wrap style2 ptb-100">
        <div class="container">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="testimonial-card style2">
                        <div class="client-info-area">
                            <div class="client-info-wrap">
                                <div class="client-img">
                                    <img src="{{asset('public_assets/img/testimonials/client-6.jpg')}}" alt="Image">
                                </div>
                                <div class="client-info">
                                    <h3>Ricky Ponting</h3>
            ...
            <ul class="page-nav list-style">
                <li><a href="testimonials.html"><i class="ri-arrow-left-s-line"></i></a></li>
                <li><a class="active" href="testimonials.html">1</a></li>
                <li><a href="testimonials.html">2</a></li>
                <li><a href="testimonials.html">3</a></li>
                <li><a href="testimonials.html"><i class="ri-arrow-right-s-line"></i></a></li>
            </ul>
        </div>
    </section>
