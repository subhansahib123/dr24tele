                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 mb-3">
                                    <div class="service-card style1 h-100">
                                        <div class="service-info">
                                          <a href="{{route('home.allDoctors',$doctorSpecialization->id)}}">  <h3>{{strtoupper($doctorSpecialization->name)}}</h3></a>
                                            {{-- <h3>{{strtoupper($doctor->user->phone_number)}}</h3>--}}
                                            <h5>Total Doctors : {{count($doctorSpecialization->specializedDoctor)}}</h4>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
