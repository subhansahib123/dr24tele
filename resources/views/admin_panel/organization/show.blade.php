                                    ...
                                    <table class="table table-striped" id="datatable">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <a href="{{route('featureOrganization',['uuid'=>$organization->uuid])}}"><button class="btn btn-secondary" title="Featured"><i class="fa fa-eye"></i></button></a>
                                                @else
                                                <a href="{{route('featureOrganization',['uuid'=>$organization->uuid])}}"><button class="btn btn-primary" title="Un-Featured"><i class="fa fa-eye-slash"></i></button></a>
                                                @endif
