                        ...
                        <div class="row">
                            <div class="col-md-12 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" action="{{route('image_categories.store')}}" method="POST"  enctype="multipart/form-data">
                                            @csrf
                                            <div class=" row mb-4">
                                                <label for="inputName" class="col-md-3 form-label"> Select Parent Category</label>
                                                <div class="col-md-9">
