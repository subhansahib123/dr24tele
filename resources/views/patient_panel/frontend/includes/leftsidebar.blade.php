            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                        ...
                        Document's</span><i class="angle fe fe-chevron-right"></i></a>
                    <ul class="slide-menu nav-tree">
                        <li><a href="{{ route('document.create') }}" class="slide-item"> Create </a></li>
                        <li><a href="{{ route('document.index') }}" class="slide-item">list</a></li>
                    </ul>
                </li>
