    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <li class="slide">
                ...
                <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('appointments') }}"><i class="side-menu__icon fa fa-calculator"></i><span class="side-menu__label">Appointments</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fa fa-users"></i><span class="side-menu__label">
