                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  value="{{old('givenName')}}" name="givenName" class="form-control"
                                    ...
                                    <div class="col-lg-6 col-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="number" value="{{old('phoneNumber')}}" name="phoneNumber" class="form-control"
                                                placeholder="+91 ********">
                                     ...
                                     <div class="col-lg-6 col-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="number" value="{{old('dateOfBirth')}}" name="dateOfBirth" class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        <p class="mb-0">Already have an Account? <a class="link style1"
                                                href="{{route('patient.login')}}">Login</a></p>
                                    </div>
                                </div>
                            </form>
                        </div>
